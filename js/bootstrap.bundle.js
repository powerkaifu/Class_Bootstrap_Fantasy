...
;(function (global, factory) {
  ...
  function arrow(_ref) {
    ...
    state.modifiersData[name] =
      ((_state$modifiersData$ = {}), (_state$modifiersData$[axisProp] = offset), (_state$modifiersData$.centerOffset = offset - center), _state$modifiersData$)
  }
  ...
  function mapToStyles(_ref2) {
    ...
    if (gpuAcceleration) {
      ...
      return Object.assign(
        ...
        (_Object$assign.transform = (win.devicePixelRatio || 1) < 2 ? 'translate(' + x + 'px, ' + y + 'px)' : 'translate3d(' + x + 'px, ' + y + 'px, 0)'),
        _Object$assign)
      )
    }
  ...
  */
  ...
  class Modal extends BaseComponent {
    ...
    _getConfig(config) {
      config = { ...Default$5, ...Manipulator.getDataAttributes(this._element), ...config }
